...
import com.ervan.intermediateone.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.location.observe(this, Observer { stories ->
            stories?.let {
                addManyMarker(it)
            }
        })
        ...
        mMap.setOnMapLongClickListener { latLng ->
            mMap.addMarker(
                MarkerOptions()
                    .position(latLng)
                    .title("New Marker")
                    .snippet("Lat: ${latLng.latitude} Long: ${latLng.latitude}")
                    .icon(vectorToBitmap(R.drawable.baseline_person_pin_circle_24, Color.parseColor("#2EE4FF")))
            )
        }
